...
from server.knowledge_base.kb_doc_api import (list_files, upload_docs, delete_docs,search_role_docs,
...
from server.utils import BaseResponse, ListResponse, FastAPI, MakeFastAPIOffline, get_server_configs, ChatMessage
...
def create_app():
    ...
    app.post("/knowledge_base/search_role_docs",
             tags=["Knowledge Base Management"],
